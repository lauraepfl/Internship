...
#Nouveau paramètre : d = 10.0,0.0
df2 = pd.read_csv("d10.txt", delim_whitespace=True, skiprows=455, nrows=62) 	
...
#Nouveau paramètre : d = 0.1,0.0
df3 = pd.read_csv("d0.1.txt", delim_whitespace=True, skiprows=724, nrows=63) 	
...
plt.plot(x1, d1, marker='x', linestyle='-',label="d_Init = 1.0")
plt.plot(x2, d2, marker='x', linestyle='-', label="d_init = 10.0")
plt.plot(x3, d3, marker='x', linestyle='-', label="d_Init = 0.1")
...
# Création du graphique
plt.plot(x1, u1, marker='x', linestyle='-',label= "d_INit = 1.0")
plt.plot(x2, u2, marker='x', linestyle='-', label="d_Init = 10.0")
plt.plot(x3, u3, marker='x', linestyle='-', label="d_Init = 0.1")
...
# Création du graphique
plt.plot(x1, p1, marker='x', linestyle='-',label="d_Init = 1.0")
plt.plot(x2, p2, marker='x', linestyle='-', label="d_Init = 10.0")
plt.plot(x3, p3, marker='x', linestyle='-', label="d_Init = 0.1")
